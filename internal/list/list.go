...
type Lister interface {
	...
	ListPack(context.Context, restic.ID, int64, int) ([]restic.Blob, int64, error)
}
...
func AllPacks(ctx context.Context, repo Lister, ignorePacks restic.IDSet, eagerEntries int, ch chan<- worker.Job) {
